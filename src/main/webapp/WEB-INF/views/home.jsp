...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .search input{
                border: none;
                box-shadow: 5px 5px 15px 5px gray inset;
        ...
        <script type="text/javascript">
        	$(document).ready(function(){
        		...
        		$(document).on("click", ".dropdown-menu li", function(e){
        			...
        			$(location).attr('href','/meet/list?cid=' + categoryID);
        		});
        	});
        </script>
    </head>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <!-- <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="/resources/assets/img/logo.svg" alt="" /></a> -->
                    ...
                    <ul class="navbar-nav text-uppercase ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <c:forEach items="${category}" var="category">
                              <li id="${category.CId}"><a class="dropdown-item" href="/meet/list"><c:out value="${category.CName}" /></a></li>
                            </c:forEach>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">개설자센터</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">당신을 설레게할 꿀같은 모임</div>
                <div class="masthead-heading text-uppercase">HONEY Bee</div>
                <!-- <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Tell Me More</a> -->
                <!-- 가운데 검색창 -->
                <div class="search" style="text-align:center; display:block; margin: 0 auto;">
                    <input type="text" id="input" placeholder="검색어를 입력해주세요."><button id="searchButton" onclick="console.log('연결 필요')">검색</button>
                </div>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">인기 게시물</h2>
                    <h3 class="section-subheading text-muted">카테고리별 인기 게시물을 구경해보세요.</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">뷰티/패션</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">원데이클래스</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">창업</div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4 mb-sm-0">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">스터디</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">취미/모임</div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © HoneyBee.com, All Rights Reserved.</div>
                ...
                <div id="footer_box">
                    <div id="address">
                        <ul>
                            <li>회사소개 | 서비스약관 및 정책 | 개인정보 취급방침 | 광고문의 | 투자정보 | 문의하기 | 제안하기 | 고객센터</li>
                            <li>주식회사 허니비 | TEAM BEMAJOR</li>
                            <li>서울특별시 종로구 종로69 YMCA 7층 | TEL.02)722-1481 | FAX.02)722-1481<br><br></li>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    <!-- Project Details Go Here-->
                                    <h2 class="text-uppercase">게시물 이름</h2>
                                    <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
